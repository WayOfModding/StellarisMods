NDefines = {
	...
	NGameplay = {
		...
		LEADER_AGE_DEATH_CHANCE_AGE	= 150,			-- Before this age the chance wont increase
		LEADER_AGE_DEATH_CHANCE_INC = 0.10,			-- Increase with these % for each year above CHANCE_AGE
